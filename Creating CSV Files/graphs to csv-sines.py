...
sine_function = a1 * sp.sin(a2 * x) + a3 * sp.cos(a4 * x)
    ...
    for a2_val in coefficients_range:
        for a3_val in coefficients_range:
            for a4_val in coefficients_range:
                result = sine_function.subs({a1: a1_val, a2: a2_val, a3: a3_val, a4: a4_val})
...
file_path = 'C:/Users/cliff/Downloads/Projects/symbolic_sine_functions.csv'
